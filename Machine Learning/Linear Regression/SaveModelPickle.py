...
import pickle
with open(r'D:\CODING_CODES\AIML\Machine Learning\Linear Regression\house_price_model_pickle','wb') as f:
    pickle.dump(model,f)

with open(r'D:\CODING_CODES\AIML\Machine Learning\Linear Regression\house_price_model_pickle','rb') as file:
    mp = pickle.load(file)
